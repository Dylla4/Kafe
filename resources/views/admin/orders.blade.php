...
<head>
    ...
    <title>Dashboard Admin - Valeria Coffee</title>
    ...
    <div class="w-64 bg-coffee-admin text-[#FDFBF7] shrink-0 p-6 flex flex-col sticky top-0 h-screen shadow-2xl">
        ...
        <nav class="flex-1 space-y-2 text-sm">
            <a href="{{ route('admin.orders') }}" 
               class="flex items-center p-3 rounded-xl transition {{ request()->routeIs('admin.orders') ? 'bg-white/10 border-l-4 border-accent-caramel font-bold text-white shadow-lg' : 'opacity-60 hover:opacity-100 hover:bg-white/5' }}">
    ...
    <div class="flex-1 p-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border-b-8 border-accent-caramel">
                ...
                <div class="flex items-baseline gap-2">
                    <h3 class="text-7xl font-black text-[#3C2A21]">{{ $ordersToday->count() }}</h3>
        ...
        <div class="mb-16">
            <div class="flex justify-between items-center mb-8">
                <h2 class="text-3xl font-black text-[#3C2A21] tracking-tighter uppercase">📦 Pesanan Terkini</h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div>
                <h2 class="text-sm font-black mb-4 uppercase tracking-[0.2em]">🕒 Penjualan Per Jam</h2>
                <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-stone-100">
                    <div class="h-64"><canvas id="hourlyChart"></canvas></div>
                </div>
            </div>
            <div>
                <h2 class="text-sm font-black mb-4 uppercase tracking-[0.2em]">📈 Tren Bulanan</h2>
                <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-stone-100">
