...
<body class="flex bg-[#FDFBF7] min-h-screen text-[#3C2A21]">
    ...
    <div class="flex-1 p-10 overflow-x-hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div class="bg-white p-8 rounded-4xl shadow-sm border-b-8 border-[#3C2A21]">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div>
                <h2 class="text-sm font-black mb-4 flex items-center text-[#3C2A21] uppercase tracking-[0.2em]">🕒 Arus Penjualan Per Jam</h2>
                <div class="bg-white p-8 rounded-4xl shadow-sm border border-stone-100">
                    <div class="h-64"><canvas id="hourlyChart"></canvas></div>
                </div>
            </div>
            <div>
                <h2 class="text-sm font-black mb-4 flex items-center text-[#3C2A21] uppercase tracking-[0.2em]">📈 Tren Penjualan Bulanan</h2>
                <div class="bg-white p-8 rounded-4xl shadow-sm border border-stone-100">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const chartOptions = {
                ...
                scales: {
                    ...
                    x: { grid: { display: false }, ticks: { color: '#3C2A21', font: { size: 9, weight: 'bold' } } }
                }
            };
            ...
            new Chart(ctxH, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        borderColor: '#3C2A21', backgroundColor: 'rgba(60, 42, 33, 0.05)',
            ...
            new Chart(ctxM, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        borderColor: '#A06040', backgroundColor: 'rgba(160, 96, 64, 0.05)',
                        borderWidth: 3, fill: true, tension: 0.4, pointRadius: 0
                    }]
                },
                options: chartOptions
