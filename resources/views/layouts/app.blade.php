...
<head>
    ...
    body { font-family: 'Plus Jakarta Sans', sans-serif; background-color: #FDFBF7; } /* Warna Cream Latte */
    .bg-coffee-dark { background-color: #3C2A21; }   /* Espresso Dark */
    .bg-coffee-medium { background-color: #5F4339; } /* Roasted Bean */
    .bg-coffee-light { background-color: #A06040; }  /* Caramel */
...
<body class="bg-white text-gray-900 flex flex-col min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        <a href="/" class="text-2xl font-extrabold text-[#3C2A21] tracking-tighter uppercase">
    ...
    <a href="{{ url('/cart') }}" class="relative p-2 ml-2">
        ...
        @endphp
        @if($totalQty > 0)
            <span class="absolute -top-1 -right-1 bg-red-600 text-white text-[10px] font-black w-5 h-5 rounded-full flex items-center justify-center shadow-md animate-pulse">
                {{ $totalQty }}
            </span>
        @endif
    </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 pt-8">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm font-medium">
                    <li><a href="/menu" class="hover:text-[#A06040] transition">Minuman Series</a></li>
                    <li><a href="/menu" class="hover:text-[#A06040] transition">Makanan Series</a></li>
                    <li><a href="/menu" class="hover:text-[#A06040] transition">Sweet Treats Series</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm font-medium">
                    <li><a href="/tentang" class="hover:text-[#A06040] transition">About Us</a></li>
                    <li><a href="/menu" class="hover:text-[#A06040] transition">Menu</a></li>
                    <li>
                        <a href="https://maps.google.com" target="_blank" class="hover:text-[#A06040] transition flex items-center gap-2">
                            📍 Bandung, Indonesia
                        </a>
                    </li>
                </ul>
            ...
            <div>
                ...
                <div class="flex gap-5">
                    ...
                    <a href="https://instagram.com/valeriacoffee" target="_blank" class="hover:scale-110 transition opacity-80 hover:opacity-100">
                        <svg class="w-7 h-7 fill-[#FDFBF7]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 2.163c3.204 0 3.584.012 4.85.07 1.17.054 1.805.249 2.227.412.56.216.96.475 1.382.897.422.422.681.822.897 1.382.164.422.359 1.057.412 2.227.059 1.266.071 1.646.071 4.85s-.012 3.584-.071 4.85c-.054 1.17-.249 1.805-.412 2.227-.216.56-.475.96-.897 1.382-.422.422-.822.681-1.382.897-.422.164-1.057.359-2.227.412-1.266.059-1.646.071-4.85.071s-3.584-.012-4.85-.071c-1.17-.054-1.805-.249-2.227-.412-.56-.216-.96-.475-1.382-.897-.422-.422-.681-.822-.897-1.382-.164-.422-.359-1.057-.412-2.227-.059-1.266-.071-1.646-.071-4.85s.012-3.584.071-4.85c.054-1.17.249-1.805.412-2.227.216-.56.475-.96.897-1.382.422-.422.822-.681 1.382-.897.422-.164 1.057-.359 2.227-.412 1.266-.059 1.646-.071 4.85-.071zM12 0C8.741 0 8.333.014 7.053.072 5.775.132 4.905.333 4.14.63c-.789.306-1.459.717-2.126 1.384S.935 3.35.63 4.14C.333 4.905.132 5.775.072 7.053.014 8.333 0 8.741 0 12s.014 3.667.072 4.947c.06 1.277.261 2.148.558 2.913.306.788.717 1.459 1.384 2.126s1.355 1.078 2.144 1.384c.766.296 1.636.499 2.913.558C8.333 23.986 8.741 24 12 24s3.667-.014 4.947-.072c1.277-.06 2.148-.262 2.913-.558.788-.306 1.459-.718 2.126-1.384s1.078-1.354 1.384-2.143c.296-.766.499-1.636.558-2.913.058-1.28.072-1.687.072-4.947s-.014-3.667-.072-4.947c-.06-1.277-.262-2.149-.558-2.913-.306-.789-.718-1.459-1.384-2.126s-1.354-1.078-2.143-1.384c-.766-.296-1.636-.499-2.913-.558C15.667.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/>
                        </svg>
                    </a>
                </div>
            </div>
